...
export const ManagerMissionThreePartTwo = async (interaction: StringSelectMenuInteraction<CacheType>, client: ClientWithCommands, serverConfigs: GuildDocument) => {
  let description = ''
  ...
  const data = {
    customId: `${interaction.user.id}-missionthree-part3`,
